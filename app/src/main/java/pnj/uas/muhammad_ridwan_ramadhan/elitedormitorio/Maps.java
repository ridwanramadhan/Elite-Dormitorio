...
import pnj.uas.muhammad_ridwan_ramadhan.elitedormitorio.model.JsonParser;
...
public class Maps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spType.setAdapter(new ArrayAdapter<>(Maps.this, android.R.layout.simple_spinner_dropdown_item, PlaceNameList));
